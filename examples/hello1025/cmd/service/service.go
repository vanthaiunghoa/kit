...
import (
	...
	grpc "hello1025/pkg/grpc"
	pb "hello1025/pkg/grpc/pb"
	http2 "hello1025/pkg/http"
	service "hello1025/pkg/service"
	"net"
	http1 "net/http"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("hello1025", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("hello1025", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterHello1025Server(baseServer, grpcServer)
